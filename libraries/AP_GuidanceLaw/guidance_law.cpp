...
// Model step function
void guidance_law::step(real32_T (&arg_POS_M)[3], real32_T (&arg_POS_T)[3],
  real32_T &arg_Az_cmd, real32_T &arg_Ay_cmd)
{
  real32_T rtb_LOS;
  real32_T rtb_TSamp;
  ...
  rtb_LOS = arg_POS_T[2] - guidance_law_P.Gain1_Gain * arg_POS_M[2];
  ...
  rtb_TSamp = rt_atan2f_snf(rtb_LOS, rtb_TSamp_h) * guidance_law_P.TSamp_WtEt;
  ...
  rtb_LOS = std::sqrt(rtb_LOS * rtb_LOS + rtb_TSamp_p) *
  ...
  arg_Az_cmd = (rtb_TSamp - guidance_law_DW.UD_DSTATE) *
    guidance_law_P.NPNconst_Value * ((rtb_LOS - guidance_law_DW.UD_DSTATE_n) *
  ...
  guidance_law_DW.UD_DSTATE_n = rtb_LOS;
