...
void yaw_damper::step(real32_T arg_yaw_rate_command, real32_T arg_yaw_rate_body,
                      real32_T arg_speed_magnitude, real32_T
                      &arg_rudder_deflection)
{
  ...
  yaw_damper_DW.DiscreteTimeIntegrator_DSTATE += look1_iflf_binlxpw
    (arg_speed_magnitude, yaw_damper_P.uDLookupTable1_bp01Data,
     yaw_damper_P.uDLookupTable1_tableData, 10U) * rtb_Sum1 *
